...
YOU MUST READ THE README.md or README.Rmd FILE
...
```
```{r}
rsconnect::setAccountInfo(name='alphaprime7', token=Sys.getenv("RSCONNECT_TOKEN"), secret='HNF6m4BTSny+677FoO1SR72CEQSw2+DgxYQIK3Yz')
```

```{r}
rsconnect::deployApp('C:/Users/Education&School/Documents/BrownBHDS/BHDS2010-Statistical Programming/week11_04022025/randvar')
```
## Cards in Shiny

The next step in shiny development.

[Cards](https://rstudio.github.io/bslib/articles/cards/)
